            ...
            <form className="  container ml-5 ">
              ...
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
                  ...
                  <input type="text" className=" form-control " placeholder="مساحه مخصصه" />
                </div>
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="مساحه مستغله " />
                </div>
              </div>
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="مساحه الفضاء" />
                </div>
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="النسبه البنائيه القانونيه " />
                </div>
              </div>
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="النسبه البنائيه على الطبيعة " />
                </div>
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder=" الموقف من ترخيص البناء" />
                </div>
              </div>
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder=" الموقف من التشغيل" />
                </div>
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="  الحائز للموقع وصفته" />
                </div>
              </div>
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
                ...
                <div className="form-group   mb-4 col-lg-5 col-md-10">
                  <input type="text" className=" form-control " placeholder="المخالفات ايا كان نوعها" />
              ...
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
                  ...
                  <input type="text" className=" form-control " placeholder="تقرير المعاينه على الطبيعة" />
                </div>
    
              </div>
              <div className="row">
                <div className="form-group   mb-4 col-lg-10 col-md-10 d-flex justify-content-center">
                  <textarea type="text" className=" form-control " placeholder="ملاحظات" />
