      ...
      <div className="container preview">
        <div className="row">
          ...
          <p className="mt-5 justify-content-start mr-5 mt-5 col-10">
            برجاء التكرم من سيادتكم بالموافقة على رفع المخلفات من الشركة بواقع
            عدد (..) نقله بمعرفة معدات ومهمات وأفراد سيادتكم ونحن على أتم
            الاستعداد لسداد الرسوم والبالغة (...) فقط لا غير
          </p>
