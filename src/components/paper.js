        ...
        <div id="home-nav">
          ...
          >
            <a className="navbar-brand" href>
              <img alt="AAA" src={img} className="img-fliud" />
            </a>
            <button
        ...
        <section className="paper">
          ...
          <div className="d-flex justify-content-start">
            <ol className="p-5 ">
              ...
              <li className="mb-1">
                ما يفيد الالتزام بالاشتراطات البيئية وعدم وجود مخالفات
              </li>
              <li className="mb-1"> صوره البطاقة </li>
              <li className="mb-1">
                {" "}
                ما يفيد سداد جميع مستحقات المنطقة الصناعية{" "}
              </li>
              <li className="mb-1"> ما يفيد رسميه توصيل المرافق</li>
              <li className="mb-1">
                {" "}
                ما يفيد التسجيل في ضريبة القيمة المضافة{" "}
              </li>
              <li className="mb-1"> إقرار بعدم وجود أي نزاع قضائي على الأرض</li>
              <li className="mb-1">
                {" "}
                رسم كروكي للموقع وما عليه من مباني معتمد من مهندس نقابي معتمد
                لدى نقابة المهندسين{" "}
              </li>
              <li className="mb-1">
                {" "}
                اخطار توقف للأنشطة المتوقفة من جهات الاختصاص موضحا به سبب التوقف
              </li>
              <li className="mb-1">
                {" "}
                أي مستند تطلبه لجنه اداره المنطقة الصناعية بخلاف ذلك طبقا
                للقوانين واللوائح المعمول بها لدى المنطقة{" "}
              </li>
            </ol>
          </div>
        </section>
