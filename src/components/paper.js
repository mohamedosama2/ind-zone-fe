  ...
  render() {
    ...
    return (
      ...
      <section className="paper container">
        <h2 className="text-center">بيان بالمستندات المطلوبة من المستثمر للتسجيل</h2>
        <div className="d-flex justify-content-start">
          <div className="row">
            <ol className="p-5 col-12">
              <li className="mb-1">سند الملكية / حيازة المتنازل (قرار التخصيص- محضر استلام) </li>
              <li className="mb-1">أن يكون المصنع يعمل بالفعل عند طلب التسجيل وغير متوقف وأن يكون قد مر على بدء الإنتاج او
                مزاولة النشاط سنه على الأقل</li>
