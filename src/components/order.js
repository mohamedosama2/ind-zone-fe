...
function Employees() {
  ...
  useEffect(() => {
    const fetch = async () => {
      const { data } = await Axios.get(`/orders?limit=3&&page=${page}`, {
        headers: {
          ...
          <div className="row">
            ...
            <section className="col-12 mt-3">
              ...
              {/* <div className="card  mb-3 col-lg-6 col-md-12 mx-auto">
                ...
                <div onClick={clicked} style={{ textAlign: "center" }} className="number d-flex justify-content-center mt-3 ">
                  {arr.map((i) => {
                    return <a href="#" onClick={hr}> {i}</a>;
                  })}
