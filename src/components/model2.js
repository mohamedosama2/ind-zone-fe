            ...
            <form className="  container ml-5 ">
              ...
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
                  ...
                  <input type="text" className=" form-control " placeholder="اسم الشركه" />
                </div>
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="اسم السيد " />
                </div>
              </div>
              <div className="row d-flex justify-content-center">
                <div className="form-group   mb-4 col-lg-5 col-md-10">
    
                  <input type="text" className=" form-control " placeholder="النشاط " />
                </div>
